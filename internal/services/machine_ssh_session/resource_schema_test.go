...
func TestMachineSSHSessionModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*machine_ssh_session.MachineSSHSessionModel)(nil)
	schema := machine_ssh_session.ResourceSchema(context.TODO())
