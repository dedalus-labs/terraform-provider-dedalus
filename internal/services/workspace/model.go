...
type WorkspaceModel struct {
	...
	ImageVersion types.String                                   `tfsdk:"image_version" json:"image_version,required,no_refresh"`
	CPUs         types.Int64                                    `tfsdk:"cpus" json:"cpus,required,no_refresh"`
	MemoryMiB    types.Int64                                    `tfsdk:"memory_mib" json:"memory_mib,required,no_refresh"`
	StorageGiB   types.Int64                                    `tfsdk:"storage_gib" json:"storage_gib,required,no_refresh"`
