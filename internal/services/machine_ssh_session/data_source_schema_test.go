...
func TestMachineSSHSessionDataSourceModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*machine_ssh_session.MachineSSHSessionDataSourceModel)(nil)
	schema := machine_ssh_session.DataSourceSchema(context.TODO())
