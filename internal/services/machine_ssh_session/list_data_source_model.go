...
type MachineSSHSessionsItemsListDataSourceEnvelope struct {
	Items customfield.NestedObjectList[MachineSSHSessionsItemsDataSourceModel] `json:"items,computed"`
}

type MachineSSHSessionsDataSourceModel struct {
	MachineID types.String                                                         `tfsdk:"machine_id" path:"machine_id,required"`
	MaxItems  types.Int64                                                          `tfsdk:"max_items"`
	Items     customfield.NestedObjectList[MachineSSHSessionsItemsDataSourceModel] `tfsdk:"items"`
	Timeouts  timeouts.Value                                                       `tfsdk:"timeouts"`
}

func (m *MachineSSHSessionsDataSourceModel) toListParams(_ context.Context) (params dedalus.MachineSSHListParams, diags diag.Diagnostics) {
...
type MachineSSHSessionsItemsDataSourceModel struct {
	ID                          types.String                                                                           `tfsdk:"id" json:"session_id,computed"`
	...
	MachineSSHSessionConnection customfield.NestedObject[MachineSSHSessionsMachineSSHSessionConnectionDataSourceModel] `tfsdk:"machine_ssh_session_connection" json:"connection,computed"`
...
type MachineSSHSessionsMachineSSHSessionConnectionDataSourceModel struct {
	...
	HostTrust       customfield.NestedObject[MachineSSHSessionsMachineSSHSessionConnectionHostTrustDataSourceModel] `tfsdk:"host_trust" json:"host_trust,computed"`
	UserCertificate types.String                                                                                    `tfsdk:"user_certificate" json:"user_certificate,computed"`
}

type MachineSSHSessionsMachineSSHSessionConnectionHostTrustDataSourceModel struct {
