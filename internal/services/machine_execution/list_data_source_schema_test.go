...
func TestMachineExecutionsDataSourceModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*machine_execution.MachineExecutionsDataSourceModel)(nil)
	schema := machine_execution.ListDataSourceSchema(context.TODO())
